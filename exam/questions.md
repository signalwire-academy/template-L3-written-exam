...
Which pattern uses a central entry point to distribute calls to specialized agents?
...
When should you use the Skill Composition pattern?
...
Which is an example of the "Monolithic Agent" anti-pattern?
...
What is the recommended approach for sharing state in horizontally scaled agents?
...
Which anti-pattern exposes implementation details to callers?
...
Which principle suggests agents should have focused, specific responsibilities?
...
What is the primary benefit of the Context State Machine pattern?
...
Which scaling pattern requires stateless agents?
...
What should be documented in agent documentation?
...
Which is NOT a recommended practice for agent architecture?
...
What is the purpose of a Gateway Router in a multi-agent system?
...
Which CLI tool builds search indexes for knowledge bases?
...
What is the purpose of "chunking" in knowledge base preparation?
...
Which parameter controls how many search results are returned?
...
What is the `distance` parameter in search configuration?
...
How can you combine static knowledge with live data?
...
What should you do when the knowledge base doesn't have an answer?
...
What is the recommended chunk size for FAQ content?
...
What is a "cold start" in serverless deployments?
...
Which technique keeps users engaged during slow operations?
...
What is the recommended timeout for external API calls in voice agents?
...
Which caching decorator is built into Python?
...
How can you run multiple warehouse checks in parallel?
...
What makes prompts "optimized" for performance?
...
What is the purpose of the `end_of_speech_timeout` parameter?
...
Which metric type is best for measuring function latency?
...
What should happen to call recording when collecting credit card numbers?
...
What is the maximum number of PIN attempts before lockout (best practice)?
...
What should be stored in logs regarding credit card numbers?
...
Which type of authentication protects SWML endpoints?
...
Which input pattern might indicate prompt injection?
...
What should happen when an account is locked due to failed PIN attempts?
...
What is the purpose of timing-safe comparison for PIN verification?
...
Which data should NEVER be in logs?
...
Which log format enables easy querying and analysis?
...
Which Prometheus metric type tracks current values (like active calls)?
...
Which alert would indicate potential AI handling issues?
...
What does `histogram_quantile(0.95, ...)` calculate?
...
What is the purpose of the `swaig-test` command `--dump-swml`?
...
How do you test a specific function with swaig-test?
...
What indicates a "degraded" health status?
...
Which pattern helps handle temporary external service failures?
...
What should logs EXCLUDE for security?
